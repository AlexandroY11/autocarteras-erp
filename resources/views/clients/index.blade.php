                ...
                <div class="flex-1 min-w-0">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <a href="https://wa.me/57{{ preg_replace('/[^0-9]/', '', $client->phone) }}" target="_blank">
                                <p class="text-blue-600 font-bold text-sm">{{ $client->phone }}</p>
                            </a>
                        </div>
                        @if(!$client->active)
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-2">
                        ...
                        <div class="flex items-center gap-2 text-gray-500">
                            ...
                            <div class="min-w-0">
                                <p class="text-[10px] font-bold text-gray-400 uppercase leading-none">Ubicación</p>
                                <p class="text-xs font-semibold text-gray-700 truncate">
                                    {{ $client->address ?? 'Dirección no disponible' }}, {{ $client->city?->name ?? 'Ciudad no disponible' }}, {{ $client->department?->name ?? 'Departamento no disponible' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-gray-500">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs font-semibold text-gray-700 truncate">{{ $client->created_at->format('d/m/Y') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
