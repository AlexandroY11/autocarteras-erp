<x-app-layout :title="isset($product) ? 'Editar Producto' : 'Crear Producto'">
<div class="max-w-3xl mx-auto pt-4 pb-12">
    ...
    <form method="POST" action="{{ isset($product) ? "/products/{$product->id}" : "/products" }}" class="space-y-6">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 relative overflow-hidden">
            {{-- Decoración sutil similar a Clientes --}}
            ...
            <div class="space-y-6 relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {{-- Días de producción --}}
                    <div class="space-y-1">
                        <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-wider">Días de Producción Promedio *</label>
