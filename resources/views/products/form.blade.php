@php
    // Definimos variables de estado para limpiar el HTML
    $isEdit = $product->exists;
    $title = $isEdit ? 'Editar Producto' : 'Crear Producto';
    $route = $isEdit ? route('products.update', $product) : route('products.store');
...
<div class="max-w-3xl mx-auto pt-4 pb-12">
    ...
    <div class="flex items-center gap-4 mb-8">
        <a href="{{ route('products.index') }}" class="w-10 h-10 bg-white border border-gray-100 rounded-xl flex items-center justify-center text-gray-400 hover:text-blue-600 transition-colors shadow-sm">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 font-medium">Gestiona los detalles técnicos del catálogo</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ $route }}" class="space-y-6">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 relative overflow-hidden">
            ...
            <div class="space-y-6 relative">
                {{-- Nombre --}}
                <div class="space-y-1">
                    <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-wider">Nombre del Producto *</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {{-- Piezas --}}
                    <div class="space-y-1">
                        <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-wider">Número de Piezas *</label>
                    ...
                    {{-- Días --}}
                    <div class="space-y-1">
                        <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-wider">Días de Producción *</label>
                ...
                {{-- Precio --}}
                <div class="space-y-1">
                    <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-wider">Precio Base de Venta *</label>
                    <div class="relative">
